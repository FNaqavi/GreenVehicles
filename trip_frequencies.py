...
plt.title('total nominal prices for each Kommun in 2013')
plt.show()
...
plt.xlabel('Kommun')
plt.ylabel('total nominal prices')
plt.title('total nominal prices for each Kommun in 2012')
plt.show()
...
plt.xlabel('Kommun')
plt.ylabel('Probabilistic total nominal prices')
plt.title('Probabilistic total nominal prices for each Kommun in 2013')
plt.show()
plt.bar(df2012['stations'], y3, color = 'black')
plt.bar(df2012['stations'], y4, bottom = y3 ,color = 'gray')
plt.legend(["2012_IN","2012_UT"])
...
plt.xlabel('Kommun')
plt.ylabel('Probabilistic total nominal prices')
plt.title('Probabilistic total nominal prices for each Kommun in 2012')
plt.show()
